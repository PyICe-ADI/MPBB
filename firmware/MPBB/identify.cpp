...
/****************************************************************************
 * Loop back speed test                                                     *
 ****************************************************************************/
// void loopback_speed_test()
// {
    // memcpy(identify_mailbox.outbox, identify_mailbox.inbox, identify_mailbox.inbox_msg_size); // this will include the Loopback command char "L"
    // identify_mailbox.to_id = identify_mailbox.from_id;
